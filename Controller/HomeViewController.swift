...
class HomeViewController: UIViewController {
    ...
    let cityId = "cityId"
    let cityArray = [City(name: "Minsk",imageName: "minsk"),City(name: "Moscow",imageName: "moscow"),City(name: "Saint-Petersburg",imageName: "saint-petersburg"),City(name: "Mogilev",imageName: "mogilev"),City(name: "Privolny",imageName: "privolny"),City(name: "Borovlyany",imageName: "borovlyany")]
